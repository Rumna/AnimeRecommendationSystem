...
create table AnimeInfo(MAL_ID int not null, Name varchar(50) not null,Score float, EnglishName varchar(50), JapaneseName varchar(50),
...
OnHold int, Dropped int, PlanToWatch int);
load data local infile 'D:/ECE 656/proj/anime.csv' ignore into table AnimeInfo
...
set MAL_ID = @col1, Name = @col2, Score = @col3, EnglishName = @col5, JapaneseName = @col6, Type = @col7, Episodes = @col8, Aired = @col9,
...
select * from animeinfo limit 10;