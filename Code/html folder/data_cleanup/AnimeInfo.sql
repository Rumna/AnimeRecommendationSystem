...
create table AnimeInfo(MALID int not null , Name varchar(120) not null,Score float, EnglishName varchar(120), JapaneseName varchar(100),
                        ...
                        OnHold int, Dropped int, PlanToWatch int,Score10 int,Score9 int, Score8 int,Score7 int,
                        Score6 int,Score5 int,Score4 int,Score3 int,Score2 int,Score1 int,Synopsis longtext,PRIMARY KEY (MALID));
...
(@col1, @col2,@col3, @col4,@col5, @col6,@col7, @col8,@col9, @col10,@col11, @col12,@col13, @col14,@col15, @col16,@col17, @col18,@col19,
 @col20,@col21, @col22, @col23, @col24,@col25, @col26,@col27, @col28,@col29, @col30, @col31, @col32, @col33, @col34, @col35,@col36)
 set MALID = @col1, Name = @col2, Score = if(@col3 = 'Unknown', NULL, @col3),
	EnglishName = @col5, JapaneseName = @col6, Type = @col7, Episodes = if(@col18 = 'Unknown', NULL, @col18), Aired = @col9,
	 ...
	 Rating = regexp_substr(@col16,'(^R - 17\+)|(^PG-13)|(^PG)|(^R\+)|(G)|(^Rx)|(^Unknown)'), Ranked= if(@col17 = 'Unknown', NULL, @col17),
     Popularity=@col18, Members= @col19, Favourites = @col20, Watching = @col21, Completed= @col22,OnHold= @col23, 
     Dropped= @col24, PlanToWatch= @col25,Score10 = if(@col26 = 'Unknown', NULL, @col26),Score9=if(@col27 = 'Unknown', NULL, @col27),
     Score8 =if(@col28 = 'Unknown', NULL, @col28) ,Score7 = if(@col29 = 'Unknown', NULL, @col29),Score6 =if(@col30 = 'Unknown', NULL, @col30) ,
     Score5 =if(@col31 = 'Unknown', NULL, @col31) ,Score4 = if(@col32 = 'Unknown', NULL, @col32),
     Score3 = if(@col33 = 'Unknown', NULL, @col33),Score2 = if(@col34 = 'Unknown', NULL, @col34),
     Score1= if(@col35 = 'Unknown', NULL, @col35),Synopsis = @col36;
...
select * from animeinfo where MALID=188  ;